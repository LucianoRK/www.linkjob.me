<script>
    const trabalheConoscoFunctions = {
        init: () => {
            trabalheConoscoFunctions.validacaoDadosCadastrais(),
                trabalheConoscoFunctions.setarDadosCadastrais(),
                trabalheConoscoFunctions.comboCidades()
        },
        comboCidades: () => {
        ...
        validacaoDadosCadastrais: () => {
            $('#salvar').on('click', function() {
                ...
                if (($('#senha').val() && $('#senha').val() != $('#repita_senha').val()) || ($('#repita_senha').val() && $('#senha').val() != $('#repita_senha').val())) {
                    erro = true;
