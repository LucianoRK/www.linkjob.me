<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="nome" value="<?= $registro['nome'] ?? ''; ?>" type="text" id="nome" class="form-control" placeholder="Nome completo">
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="nome_artistico" value="<?= $registro['nome_artistico'] ?? ''; ?>" type="text" id="nome_artistico" class="form-control">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-2"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="data_nascimento" value="<?= $registro['data_nascimento'] ?? ''; ?>" type="date" id="data_nascimento" class="form-control">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="cpf" value="<?= $registro['cpf'] ?? ''; ?>" type="text" id="cpf" class="form-control cpfMask">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="rg" value="<?= $registro['rg'] ?? ''; ?>" type="text" id="rg" class="form-control">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="area" value="<?= $registro['area'] ?? ''; ?>" type="text" id="area" class="form-control">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-2"></div>
    ...
    <div class="col-md-6">
        <input name="instituicao" value="<?= $registro['instituicao'] ?? ''; ?>" type="text" id="instituicao" class="form-control">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-2"></div>
    ...
    <div class="col-md-6">
        <input name="idiomas" value="<?= $registro['idiomas'] ?? ''; ?>" type="text" id="idiomas" class="form-control">
    </div>
</div>
<hr>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="endereco" value="<?= $registro['endereco'] ?? ''; ?>" type="text" id="endereco" class="form-control" placeholder="Endereço completo">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="complemento" value="<?= $registro['complemento'] ?? ''; ?>" type="text" id="complemento" class="form-control">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-2"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="cep" value="<?= $registro['cep'] ?? ''; ?>" type="text" id="cep" class="form-control cepMask">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<hr>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="celular" value="<?= $registro['celular'] ?? ''; ?>" type="text" id="celular" class="form-control celularMask">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="instagram" value="<?= $registro['instagram'] ?? ''; ?>" type="text" id="instagram" class="form-control" placeholder="Link do seu Instagram">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<hr>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="banco" value="<?= $registro['banco'] ?? ''; ?>" type="text" id="banco" class="form-control">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="agencia" value="<?= $registro['agencia'] ?? ''; ?>" type="text" id="agencia" class="form-control">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="conta" value="<?= $registro['conta'] ?? ''; ?>" type="text" id="conta" class="form-control">
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input name="pix" value="<?= $registro['pix'] ?? ''; ?>" type="text" id="pix" class="form-control">
    </div>
</div>
<div class="form-group row">
    <div class="col-md-2"></div>
    ...
    <div class="col-md-6">
        <input name="pic_pay" value="<?= $registro['pic_pay'] ?? ''; ?>" type="text" id="pic_pay" class="form-control">
    </div>
</div>