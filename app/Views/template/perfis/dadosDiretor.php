...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <div class="input-group">
            <select class="multiple-select input-diretor categoria-fotos-diretor" name="diretor[0][categorias][]" multiple="multiple">
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input type="file" name="diretor[0]" class="btn btn-primary upload-diretor" accept="image/png, image/jpg, image/jpeg" multiple />
        <span class="text-danger msg" style="font-size: 13px;"></span>
