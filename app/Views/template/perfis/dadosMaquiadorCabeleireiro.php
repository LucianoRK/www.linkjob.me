...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <div class="input-group">
            <select class="multiple-select categoria-fotos-maquiador-cabeleireiro input-maquiador-cabeleireiro" name="maquiador_cabeleireiro[0][categorias][]" multiple="multiple">
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input type="file" name="maquiador_cabeleireiro[0]" class="btn btn-primary upload-maquiador-cabeleireiro" accept="image/png, image/jpg, image/jpeg" multiple />
        <span class="text-danger msg" style="font-size: 13px;"></span>
