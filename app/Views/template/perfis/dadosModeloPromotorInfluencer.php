    ...
    <div class="col-md-6">
        <div class="input-group">
            ...
            <span class="input-group-btn">
                <button style="height: 38px;" class="btn btn-default" type="button" id="adicionar-input-foto-modelo-influencer-promotor"><i class="text-success fas fa-plus"></i></button>
            </span>
        </div>
        <span class="text-danger msg" style="font-size: 13px;"></span>
    </div>
