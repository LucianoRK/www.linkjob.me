...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <div class="input-group">
            <select class="multiple-select categoria-fotos-locacao input-locacao" name="locacao[0][categoria][]" multiple="multiple">
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input type="file" name="locacao[0][upload][]" class="btn btn-primary upload-locacao" accept="image/png, image/jpg, image/jpeg" multiple />
        <span class="text-danger msg" style="font-size: 13px;"></span>
