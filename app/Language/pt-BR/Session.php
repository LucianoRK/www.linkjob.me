...
return [
  ...
  'invalidSavePath'        => 'Sessão: O save path "{0}" configurado não é um diretório.',
  ...
  'invalidSameSiteSetting' => 'Sessão: A configuração SameSite deve ser None, Lax, Strict, ou uma string vazia.',
];
